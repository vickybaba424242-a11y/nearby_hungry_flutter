    ...
    try {
      ...
      if (user != null) {
        ...
        if (!existingDoc.exists) {
          ...
          final referralDoc = await FirebaseFirestore
              .instance
          ...
          print("Created Google user with referral code: $referralCode");
          ...
          if (referralCode == null || referralCode.isEmpty) {
            ...
            debugPrint(
              "Fixed old user referral code: $referralCode",
            );
          }
